...
import net.minecraft.server.v1_9_R2.*; // Changement de la version NMS
import org.bukkit.craftbukkit.v1_9_R2.entity.CraftPlayer; // Changement de la version CraftBukkit
...
public class ScoreboardSign {
    ...
    private void sendLine(int line) {
        ...
        getPlayer().sendPacket(sendScore(team.getCurrentPlayer(), score));
        team.reset();
    }
